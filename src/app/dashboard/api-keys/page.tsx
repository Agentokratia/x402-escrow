            ...
            <div className={styles.howItWorks}>
              ...
              <div className={styles.flowStory}>
                ...
                <div className={styles.storyStep}>
                  ...
                  <p>
                    Client signs escrow → Retry with <strong>PAYMENT-SIGNATURE</strong> header →
                    Session created
                  </p>
                </div>
                <div className={styles.storyStep}>
            ...
            <div className={styles.yourJobs}>
              ...
              <div className={styles.jobCard}>
                ...
                <div className={styles.codeExample}>
                  <pre>{`npm install @x402/core @x402/express @x402/escrow`}</pre>
                </div>
              </div>
    ...
    accepts: { scheme: 'escrow', price: '$0.01', payTo: '0x...' },
            ...
            <div className={styles.apiReference}>
              ...
              <p className={styles.apiNote}>
                Base URL: <code>https://facilitator.agentokratia.com</code> • Used by x402
